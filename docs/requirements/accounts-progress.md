...
Rationale: Plusieurs joueurs doivent pouvoir utiliser le même jeu sans partager la même progression.
...
Rationale: La progression doit être persistante sans faire du navigateur la source de vérité.
...
Rationale: La progression sauvegardée doit être associée au bon joueur dès le début de la session.
...
Rationale: Un nouveau joueur doit pouvoir commencer une progression séparée sans modifier les comptes existants.
...
Rationale: Un joueur doit pouvoir corriger ou personnaliser le nom de son compte sans perdre sa progression.
...
Rationale: Un joueur doit pouvoir recommencer la campagne sans supprimer les autres comptes locaux.
...
Rationale: Un joueur doit pouvoir retirer un compte devenu inutile sans affecter les autres comptes locaux.
...
Rationale: L'enfant ne doit pas avoir à déclencher une sauvegarde manuelle.
...
Rationale: Le joueur doit pouvoir continuer la campagne sans rechercher manuellement son niveau.
...
Rationale: La première version du suivi de progression doit rester simple et prévisible.
...
Rationale: La progression d'un joueur ne doit pas modifier celle d'un autre joueur.
...
Rationale: Le jeu doit rester jouable même si le stockage serveur est temporairement indisponible.
