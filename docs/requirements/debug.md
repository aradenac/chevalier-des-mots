...
Rationale:
Les testeurs doivent pouvoir accéder rapidement au mode debug sans modifier l'URL, le code ou la configuration du navigateur.
...
Rationale:
Le concepteur ou testeur doit pouvoir tester rapidement un niveau précis sans parcourir toute la progression normale.
...
Rationale:
Le mode debug doit permettre de tester les niveaux sans créer ou sélectionner un compte enfant.
...
Rationale:
Le mode debug doit permettre de tester un niveau rapidement sans passer par le flux normal de choix du personnage.
...
Rationale:
Le test libre d'un niveau ne doit pas débloquer artificiellement la campagne ni perturber la progression réelle d'un enfant.
...
Rationale:
Les essais de conception ou de test ne doivent pas polluer le Tableau des champions ni les meilleurs scores.
...
Rationale:
Le mode debug doit tester les niveaux dans des conditions fonctionnelles représentatives, sans contourner les prérequis critiques.
