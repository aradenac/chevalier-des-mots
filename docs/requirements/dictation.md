...
Rationale: La dictée doit être jouée comme un niveau à part entière, au même titre que les niveaux de tranchage, et non comme un exercice intercalé entre deux niveaux ou à l'intérieur d'un autre niveau.
...
Rationale: Les textes dictés doivent rester éditables comme contenu pédagogique sans modifier le moteur.
...
Rationale: Un niveau de dictée ne doit pas être limité à un texte fixe afin de favoriser le rejeu et la mémorisation espacée.
...
Rationale: La difficulté de saisie doit augmenter progressivement pour rester cohérente avec le niveau CE1 visé.
...
Rationale: La dictée repose sur l'écoute du texte attendu avant la saisie.
...
Rationale: L'enfant doit pouvoir réécouter autant que nécessaire sans être pénalisé.
...
Rationale: La dictée doit évaluer la transcription du texte entendu, pas une copie visuelle.
...
Rationale: L'enfant doit pouvoir terminer l'exercice ou recommencer sa saisie sans utiliser une mécanique de tranchage.
...
Rationale: La dictée doit être une activité posée de transcription et de correction.
...
Rationale: La dictée doit rester intégrée à l'univers du Chevalier des mots.
...
Rationale: Une variante déclarée acceptée doit avoir la même valeur que le texte principal attendu.
...
Rationale: Une comparaison par caractère permet de traiter les ajouts, suppressions et remplacements de manière déterministe.
...
Rationale: Le score doit rester modéré pour les petites erreurs tout en valorisant la précision orthographique.
...
Rationale: Le joueur doit comprendre la nature des écarts entre ce qu'il a entendu et ce qu'il a écrit.
...
Rationale: L'enfant doit pouvoir améliorer son score sans être bloqué par une erreur.
...
Rationale: La dictée doit contribuer au suivi de progression comme les autres niveaux.
