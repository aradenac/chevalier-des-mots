...
| <code>req&#126;account.local-database-storage&#126;1</code> | test | impl, utest | At least one impl link to this requirement after implementation. | At least one utest link to this requirement after implementation. | `build/test-results/vitest-junit.xml`; `build/traceability/openfasttrace.txt`; `build/traceability/openfasttrace.html` |
