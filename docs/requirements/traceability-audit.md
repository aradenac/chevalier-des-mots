...
| <code>req&#126;account.local-accounts&#126;1</code> | test | impl, utest | At least one impl link to this requirement after implementation. | At least one utest link to this requirement after implementation. | `build/test-results/vitest-junit.xml`; `build/traceability/openfasttrace.txt`; `build/traceability/openfasttrace.html` |
| <code>req&#126;account.server-database-storage&#126;1</code> | test | impl, utest | At least one impl link to this requirement after implementation. | At least one utest link to this requirement after implementation. | `build/test-results/vitest-junit.xml`; `build/traceability/openfasttrace.txt`; `build/traceability/openfasttrace.html` |
| <code>req&#126;account.start-selection&#126;1</code> | test | impl, utest | At least one impl link to this requirement after implementation. | At least one utest link to this requirement after implementation. | `build/test-results/vitest-junit.xml`; `build/traceability/openfasttrace.txt`; `build/traceability/openfasttrace.html` |
| <code>req&#126;account.creation&#126;1</code> | test | impl, utest | At least one impl link to this requirement after implementation. | At least one utest link to this requirement after implementation. | `build/test-results/vitest-junit.xml`; `build/traceability/openfasttrace.txt`; `build/traceability/openfasttrace.html` |
| <code>req&#126;account.rename&#126;1</code> | test | impl, utest | At least one impl link to this requirement after implementation. | At least one utest link to this requirement after implementation. | `build/test-results/vitest-junit.xml`; `build/traceability/openfasttrace.txt`; `build/traceability/openfasttrace.html` |
| <code>req&#126;account.reset&#126;1</code> | test | impl, utest | At least one impl link to this requirement after implementation. | At least one utest link to this requirement after implementation. | `build/test-results/vitest-junit.xml`; `build/traceability/openfasttrace.txt`; `build/traceability/openfasttrace.html` |
| <code>req&#126;account.deletion&#126;1</code> | test | impl, utest | At least one impl link to this requirement after implementation. | At least one utest link to this requirement after implementation. | `build/test-results/vitest-junit.xml`; `build/traceability/openfasttrace.txt`; `build/traceability/openfasttrace.html` |
| <code>req&#126;progress.auto-save-completed-level&#126;1</code> | test | impl, utest | At least one impl link to this requirement after implementation. | At least one utest link to this requirement after implementation. | `build/test-results/vitest-junit.xml`; `build/traceability/openfasttrace.txt`; `build/traceability/openfasttrace.html` |
| <code>req&#126;progress.resume-next-unfinished-level&#126;1</code> | test | impl, utest | At least one impl link to this requirement after implementation. | At least one utest link to this requirement after implementation. | `build/test-results/vitest-junit.xml`; `build/traceability/openfasttrace.txt`; `build/traceability/openfasttrace.html` |
| <code>req&#126;progress.linear-progression&#126;1</code> | test | impl, utest | At least one impl link to this requirement after implementation. | At least one utest link to this requirement after implementation. | `build/test-results/vitest-junit.xml`; `build/traceability/openfasttrace.txt`; `build/traceability/openfasttrace.html` |
| <code>req&#126;progress.account-isolation&#126;1</code> | test | impl, utest | At least one impl link to this requirement after implementation. | At least one utest link to this requirement after implementation. | `build/test-results/vitest-junit.xml`; `build/traceability/openfasttrace.txt`; `build/traceability/openfasttrace.html` |
| <code>req&#126;account.storage-failure-non-blocking&#126;1</code> | test | impl, utest | At least one impl link to this requirement after implementation. | At least one utest link to this requirement after implementation. | `build/test-results/vitest-junit.xml`; `build/traceability/openfasttrace.txt`; `build/traceability/openfasttrace.html` |
